...
const ProductCard = ({ id, imageUrl, title, description, price, rating }) => {
  ...
  return (
    <div className="flex flex-col w-1/5 cursor-pointer p-2 border border-gray-300 rounded-lg bg-white hover:shadow-lg transition-shadow ease-in-out duration-300" onClick={openProductDetails}>
